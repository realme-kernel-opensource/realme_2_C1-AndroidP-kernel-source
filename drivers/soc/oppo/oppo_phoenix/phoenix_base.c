...
static void phx_action_set_bootstage(const char *);
static void phx_action_set_booterror(const char *);

static void phx_handle_hang_oppo_over_4_mins(const char *);
static void phx_handle_hang_oppo_over_8_mins(const char *);
...
static phx_action_mapping monitor_action_mapping[] = {
    {ACTION_SET_BOOTSTAGE, phx_action_set_bootstage},
    {ACTION_SET_BOOTERROR, phx_action_set_booterror},
};
...
static phx_action_mapping errno_handle_action_mapping[] = {
    ...
    {ERROR_HANG_OPPO_OVER_8_MINS, phx_handle_hang_oppo_over_8_mins},
    {ERROR_HANG_OPPO_OVER_4_MINS, phx_handle_hang_oppo_over_4_mins},
...
static void phx_handle_hang_oppo_over_8_mins(const char *happen_time)
{
    phx_klog_booterror(ERROR_HANG_OPPO_OVER_8_MINS, happen_time);
    phx_log_dump(ERROR_HANG_OPPO_OVER_8_MINS);
}

static void phx_handle_hang_oppo_over_4_mins(const char *happen_time)
{
    phx_klog_booterror(ERROR_HANG_OPPO_OVER_4_MINS, happen_time);
    phx_log_dump(ERROR_HANG_OPPO_OVER_4_MINS);
}

static void phx_action_set_bootstage(const char *stage)
{
...
static void phx_action_set_booterror(const char *errno)
{
    phx_choose_action_handler(errno, errno_handle_action_mapping, ARRAY_SIZE(errno_handle_action_mapping));
}
