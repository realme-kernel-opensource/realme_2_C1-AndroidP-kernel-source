...
const struct bug_entry *qihoo_patch_find_bug(unsigned long bugaddr)
{
	struct module *mod;
...
static inline const struct bug_entry *qihoo_patch_find_bug(unsigned long bugaddr)
{
	return NULL;
}
#endif
